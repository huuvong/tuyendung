class DiadiemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @diadiem.save
        format.html { redirect_to @diadiem, notice: 'Diadiem was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @diadiem.update(diadiem_params)
        format.html { redirect_to @diadiem, notice: 'Diadiem was successfully updated.' }
  ...
  def destroy
    @diadiem.destroy
    respond_to do |format|
      format.html { redirect_to diadiems_url, notice: 'Diadiem was successfully destroyed.' }
