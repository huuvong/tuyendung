class VitricongviecsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @vitricongviec.save
        format.html { redirect_to @vitricongviec, notice: 'Vitricongviec was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @vitricongviec.update(vitricongviec_params)
        format.html { redirect_to @vitricongviec, notice: 'Vitricongviec was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to vitricongviecs_url, notice: 'Vitricongviec was successfully destroyed.' }
