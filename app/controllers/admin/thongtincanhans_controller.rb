class Admin::ThongtincanhansController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @thongtincanhan.save
        format.html { redirect_to admin_thongtincanhans_url, notice: 'Thongtincanhan was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @thongtincanhan.update(thongtincanhan_params)
        format.html { redirect_to edit_admin_thongtincanhan_path, notice: 'Thongtincanhan was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_thongtincanhans_url, notice: 'Thongtincanhan was successfully destroyed.' }
